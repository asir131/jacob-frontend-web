           ...
           <motion.div variants={item}>
             <Card className="border-none shadow-md shadow-slate-200/50 bg-white group hover:scale-[1.02] transition-transform duration-300">
               <CardHeader className="flex flex-row items-center justify-between py-5 pb-2">
                 ...
                 <div className="p-2 bg-blue-50 rounded-lg" aria-hidden="true"><Clock size={16} className="text-blue-500" /></div>
               </CardHeader>
               <CardContent className="pb-6">
           ...
           <motion.div variants={item}>
             <Card className="border-none shadow-md shadow-slate-200/50 bg-white group hover:scale-[1.02] transition-transform duration-300">
               <CardHeader className="flex flex-row items-center justify-between py-5 pb-2">
                 ...
                 <div className="p-2 bg-indigo-50 rounded-lg" aria-hidden="true"><CheckSquare size={16} className="text-indigo-500" /></div>
               </CardHeader>
               <CardContent className="pb-6">
           ...
           <motion.div variants={item}>
             <Card className="border-none shadow-md shadow-slate-200/50 bg-white group hover:scale-[1.02] transition-transform duration-300">
               <CardHeader className="flex flex-row items-center justify-between py-5 pb-2">
                 ...
                 <div className="p-2 bg-amber-50 rounded-lg" aria-hidden="true"><Star size={16} className="text-amber-500 fill-amber-500" /></div>
               </CardHeader>
               <CardContent className="pb-6">
