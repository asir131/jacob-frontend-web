...
import {
  ...
  DollarSign, Clock, Briefcase, ArrowRight, ChevronRight
} from 'lucide-react';
...
const perks = [
  ...
  { icon: <Briefcase size={24} />, title: 'Insurance Coverage', desc: 'We provide up to ৳50,000 in service liability coverage per job.' },
];
    ...
    <div className="min-h-screen bg-[#F8FAFC]">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
            ...
            <p className="text-slate-400 text-xl font-medium max-w-2xl mx-auto mb-10">
              Join 5,000+ professionals earning on LocallyServe. Set your own hours, build your client base, and get paid fast.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/provider/dashboard">
                <Button variant="outline" className="h-16 px-12 border-white/20 text-white hover:bg-white/10 font-black text-lg rounded-2xl">
                  See How It Works
                </Button>
              </Link>
            </div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }} className="mt-16 flex flex-wrap items-center justify-center gap-10">
            {[['৳ 2.4Cr+', 'Paid to Providers'], ['5,200+', 'Active Providers'], ['98.2%', 'Satisfaction Rate']].map(([val, label]) => (
      ...
      <section className="bg-white py-28">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <span className="inline-flex bg-[#2286BE]/10 text-[#2286BE] px-4 py-2 rounded-full font-black text-xs uppercase tracking-widest mb-4">Why LocallyServe</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {perks.map((perk, i) => (
              <motion.div key={perk.title} initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ delay: i * 0.08 }}
                ...
                <div className="h-12 w-12 shrink-0 bg-primary-soft rounded-2xl flex items-center justify-center text-[#2286BE]">{perk.icon}</div>
                <div>
      ...
      <section className="pb-28 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto bg-slate-900 rounded-[3rem] p-16 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-slate-400 font-medium mb-10 max-w-lg mx-auto">Join thousands of professionals already growing their business on LocallyServe.</p>
            <Link href="/signup">
